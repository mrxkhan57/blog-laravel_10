    ...
    >
      <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          >
            <img class="flaticon-043-teddy-bear"></img>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            >
            <a class="text-white mb-2" href="{{url('news')}}"
              ><i class="fa fa-angle-right mr-2"></i>Our News</a
            >
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class="text-primary font-weight-bold" href="#">News</a>.
          All Rights Reserved.
